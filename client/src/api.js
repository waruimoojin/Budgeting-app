...
export const addCategory = (category) => axios.post(`${BASE_URL}/category`, category);

export const getTransactions = () => axios.get(`${BASE_URL}/transactions`);
export const addTransaction = (transaction) => axios.post(`${BASE_URL}/transactions`, transaction);
